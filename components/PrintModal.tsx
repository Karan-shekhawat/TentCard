      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full animate-in fade-in zoom-in duration-200">
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your name plates are prepared for A4 or Letter paper.<br />
            Review the layout and continue when you're ready.
          </p>

          <div className="bg-gray-50 p-4 rounded-lg mb-6 border border-gray-100">
            <p className="text-sm text-gray-500 flex items-center justify-center gap-1 font-medium">
              Developed by <span className="text-blue-600">Karan Shekhawat</span> with <Heart className="w-3 h-3 text-red-500 fill-red-500" />
            </p>
